...
**Status:** ✅ Built, tested, and living at the repository root so Vercel builds
it by default with no configuration.
...
1. Import the repo at <https://vercel.com/new> and deploy — no settings needed
   now that the app is at the repository root. An older project may still hold
   a stale Root Directory; clear it back to the root.
